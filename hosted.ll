...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_hosted.cc, i8* null }]
...
define dso_local float @_Z3addff(float %0, float %1) #4 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_hosted.cc() #0 section ".text.startup" {
